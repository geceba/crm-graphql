        ...
        <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navegacion">
                <ul className="navbar-nav ml-auto text-right">
                    <li className="nav-item dropdown mr-md-2 mr-2 mb-md-0">
                        <button
                            className="nav-link dropdown-toggle btn btn-block btn-success"
                            data-toggle="dropdown"
                        >Clientes</button>
                        <div className="dropdown-menu" aria-labelledby="navegacion">
                            <Link to="/customer" className="dropdown-item">Ver Clientes</Link>
                            <Link to="/customer/new" className="dropdown-item">Nuevo Cliente</Link>
                        </div>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navegacion">
                            ...
                            <Link to="/products/new" className="dropdown-item">Nuevo Producto</Link>
                        </div>
